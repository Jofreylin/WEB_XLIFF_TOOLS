...
## Description
XLIFF Tools is a web application designed to simplify the translation process of XLF and XLIFF files, which are commonly used for app internationalization.
